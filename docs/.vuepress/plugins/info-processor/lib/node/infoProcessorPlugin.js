...
exports.infoProcessorPlugin = void 0;
exports.infoProcessorPlugin = {
    name: 'info-processor',
};
const arr = [
    ['超级罕见', 'red'],
...
exports.infoProcessorPlugin.extendsMarkdown = (md) => {
    md.core.ruler.before('curly_attributes', 'mastermind', mastermind);
};
//# sourceMappingURL=infoProcessorPlugin.js.map